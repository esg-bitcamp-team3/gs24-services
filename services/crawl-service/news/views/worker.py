...
from model import ESG_CNN  # 경로는 실제 파일 구조에 맞게 조정!
...
for message in consumer:
    try:
        ...
        today_date = message.value.get("date") or datetime.today().strftime('%Y-%m-%d')
        print(f"[Kafka 수신] {company_name} {today_date}")
